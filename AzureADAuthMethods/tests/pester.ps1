...
Remove-Module AzureADAuthMethods -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\AzureADAuthMethods.psd1"
Import-Module "$PSScriptRoot\..\AzureADAuthMethods.psm1" -Force
